...
import kotlinx.android.synthetic.main.long_card_view.view.*

@RequiresApi(Build.VERSION_CODES.LOLLIPOP)
class LongCardView @JvmOverloads constructor(
    context: Context,
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.long_card_view, this, true)
    ...
    fun setNumber(number: String?) {
        if (!number.isNullOrEmpty()) card_number.text = number
    }
}